...
<div class="page">
    <div class="card">
        ...
        <p>The username or password you entered was incorrect.<br>Please try again or reset your password.</p>
        <div class="btn-row">
            <a href="login.php" class="btn btn-primary">
                <i class="fa-solid fa-arrow-left"></i>&ensp;Try Again
            </a>
            <a href="forgot.php" class="btn btn-secondary">
                <i class="fa-solid fa-key"></i>&ensp;Forgot Password?
            </a>
        </div>
        <div class="meta">
            Failed attempt &mdash; <?php echo date('Y-m-d H:i:s'); ?>
        </div>
    </div>
</div>
